...
export default function RewardsSection() {
  ...
  return (
    <section id="rewards" ref={ref} className="relative py-16 sm:py-20 md:py-24 lg:py-32 px-4 z-10">
        ...
        <div className={`space-y-12 sm:space-y-16 fade-in-up ${isVisible ? 'visible' : ''}`}>
          ...
          <div className="text-center space-y-4 sm:space-y-6">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-tight text-primary">
              Rewards & <span className="drop-shadow-[0_0_15px_rgba(168,85,247,0.6)]">Achievements</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 pt-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-primary mb-2">
                  {stat.value}
                </div>
